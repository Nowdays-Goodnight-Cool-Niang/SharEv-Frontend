    ...
    <div className="min-h-screen">
      ...
      <div className="wrapper py-6">
        <div className="space-y-6 text-gray-200">
          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">제1조 (목적)</h2>
          ...
          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">제2조 (정의)</h2>
            <p className="text-body-3 mb-2 text-gray-400">
              이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
            </p>
            <ul className="text-body-3 list-inside list-disc space-y-2 text-gray-400">
              <li>"서비스"란 SharE:v 플랫폼 및 관련 서비스를 의미합니다.</li>
              <li>"이용자"란 이 약관에 따라 서비스를 받는 회원 및 비회원을 말합니다.</li>
              <li>
                "회원"이란 서비스 이용계약을 체결하고 이용자 아이디(ID)를 부여받은 자를 의미합니다.
              </li>
              <li>
            ...
            <p className="text-body-3 mb-2 text-gray-400">
              이 약관에서 사용하는 용어의 정의는 본 조 제1항에서 정하는 것을 제외하고는 관계법령 및
              서비스별 정책에서 정하는 바에 의하며, 이에 정하지 아니한 것은 일반적인 상 관례에
              따릅니다.
            </p>
          </section>

          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">제3조 (약관의 효력 및 변경)</h2>
            <div className="space-y-3">
              ...
              <p className="text-body-3 text-gray-400">
                ...
                공지합니다. 다만, 변경된 내용이 회원에게 불리하거나 중대한 사항의 변경인 경우에는 그
                적용일 30일 이전까지 본문과 같은 방법으로 공지하고 제28조 제1항의 방법으로 회원에게
                통지합니다. 이 경우 개정 전 내용과 개정 후 내용을 명확하게 비교하여 회원이 알기
                쉽도록 표시합니다.
              </p>
              <p className="text-body-3 text-gray-400">
                ④ 서비스가 약관을 개정할 경우 개정약관 공지 후 개정약관의 적용에 대한 회원의 동의
                여부를 확인합니다. 서비스는 제2항의 공지 또는 통지를 할 경우 회원이 개정약관에 대해
                동의 또는 거부의 의사표시를 하지 않으면 동의한 것으로 볼 수 있다는 내용도 함께 공지
                또는 통지를 하며, 회원이 이 약관 시행일까지 거부의 의사표시를 하지 않는다면
                개정약관에 동의한 것으로 간주합니다. 회원이 개정약관에 대해 동의하지 않는 경우
                서비스는 회원과의 계약을 해지할 수 있습니다.
              </p>
            </div>
          </section>

          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">제4조 (이용계약의 체결 및 적용)</h2>
            <div className="space-y-3">
              <p className="text-body-3 text-gray-400">
              ...
              <p className="text-body-3 text-gray-400">
                ② 서비스는 가입신청자의 신청에 대하여 승낙함을 원칙으로 합니다. 다만, 서비스는 다음
                각 호의 어느 하나에 해당하는 이용 신청에 대해서는 승낙을 거절하거나 사후에
                이용계약을 해지할 수 있습니다.
              </p>
              <ul className="text-body-3 ml-4 list-inside list-disc space-y-2 text-gray-400">
          ...
          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">제5조 (약관 외 준칙)</h2>
            <p className="text-body-3 text-gray-400">
              이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 「전자상거래 등에서의
              소비자보호에 관한 법률」,「약관의 규제에 관한 법률」,「정보통신망이용촉진 및 정보보호
              등에 관한 법률」 등 관련 법령 또는 상 관례에 따릅니다.
            </p>
          </section>

          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">제6조 (개인정보보호)</h2>
            <div className="space-y-3">
              <p className="text-body-3 text-gray-400">
              ...
              <p className="text-body-3 text-gray-400">
                ③ 서비스는 관련 법령에 의해 관련 국가기관 등의 요청이 있는 경우를 제외하고는 회원의
          ...
          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">제7조 (서비스의 의무)</h2>
            <div className="space-y-3">
              <p className="text-body-3 text-gray-400">
              ...
              <p className="text-body-3 text-gray-400">
                ...
                위해 보안시스템을 갖추어야 하며 개인정보처리방침을 공시하고 준수합니다. 서비스는 이
                약관 및 개인정보처리방침에서 정한 경우를 제외하고는 회원의 개인정보가 제3자에게 공개
                또는 제공되지 않도록 합니다.
              </p>
              <p className="text-body-3 text-gray-400">
          ...
          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">제8조 (회원의 의무)</h2>
            <div className="space-y-3">
              <p className="text-body-3 text-gray-400">
              ...
              <ul className="text-body-3 ml-4 list-inside list-disc space-y-2 text-gray-400">
                ...
                <li>
                  서비스의 직원이나 운영자를 가장하거나 타인의 명의를 도용하여 메일을 발송하는 행위,
                ...
                <li>
                  ...
                  고안된 바이러스⋅컴퓨터 코드⋅파일⋅프로그램 등을 고의로 전송⋅게시⋅유포 또는 사용하는
                  행위
                </li>
                <li>
                  서비스로부터 특별한 권리를 부여 받지 않고 애플리케이션을 변경하거나,
                  애플리케이션에 다른 프로그램을 추가⋅삽입하거나, 서버를 해킹⋅역설계하거나, 소스
                  코드나 애플리케이션 데이터를 유출⋅변경하거나, 별도의 서버를 구축하거나, 웹사이트의
                  일부분을 임의로 변경⋅도용하여 서비스를 사칭하는 행위
                </li>
          ...
          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">제9조 (서비스 내용 및 변경)</h2>
            <div className="space-y-3">
              <p className="text-body-3 text-gray-400">
                ① 원활한 게임서비스 제공을 위해 운영상 또는 기술상의 필요에 따라 서비스를 변경할 수
                있으며, 변경 전에 해당 내용을 게임서비스 내에 공지합니다. 다만, 버그․오류 등의
          ...
          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">제10조 (정보의 수집)</h2>
            <div className="space-y-3">
              <p className="text-body-3 text-gray-400">
              ...
              <p className="text-body-3 text-gray-400">
                ② 서비스 개선 및 회원 대상 서비스 소개 등을 위한 목적으로 회원에게 추가정보를 요청할
                수 있습니다. 이 요청에 대해 회원은 승낙하거나 거절할 수 있으며, 서비스가 이 요청을
                할 경우에는 회원이 이 요청을 거절할 수 있다는 뜻을 함께 고지합니다.
              </p>
            </div>
          </section>

          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">제11조 (저작권 등의 귀속)</h2>
            <div className="space-y-3">
              <p className="text-body-3 text-gray-400">
              ...
              <p className="text-body-3 text-gray-400">
                ...
                금지행위에 해당된다고 판단되는 경우에는 사전 통지 없이 이를 삭제 또는 이동하거나 그
                등록을 거절할 수 있습니다.
              </p>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">
            ...
            <div className="space-y-3">
              <p className="text-body-3 text-gray-400">
                ...
                회원에게 사전 통지합니다. 다만, 긴급히 조치할 필요가 있는 경우에는 사후에 통지할 수
                있습니다.
              </p>
              <ul className="text-body-3 ml-4 list-inside list-disc space-y-2 text-gray-400">
                <li>이용제한 조치의 사유</li>
          ...
          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">제12조 (계약 해지)</h2>
            <div className="space-y-3">
              <p className="text-body-3 text-gray-400">
                ① 회원은 언제든지 서비스 이용을 원하지 않는 경우 회원 탈퇴를 통해 이용계약을 해지할
                수 있습니다. 회원탈퇴로 인해 회원이 서비스 내에서 보유한 이용정보는 모두 삭제되어
                복구가 불가능하게 됩니다.
              </p>
              <p className="text-body-3 text-gray-400">
                ② 회원이 본 이용계약을 해지할 경우, 관련 법령 및 서비스의 개인정보보호정책에서 정한
                바에 따라 서비스가 회원정보를 보유하는 경우를 제외하고는, 해지 즉시 회원이 등록한
                정보 등 모든 데이터는 소멸됩니다
              </p>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">제13조 (손해배상 및 면책조항)</h2>
            <div className="space-y-3">
              <p className="text-body-3 text-gray-400">
                ① 회원은 본 약관을 위반하여 상대방에게 손해를 입힌 경우에는 그 손해를 배상할 책임이
                있습니다. 다만, 고의 또는 과실이 없는 경우에는 그러하지 아니 합니다.
              </p>
              <p className="text-body-3 text-gray-400">
              ...
              <p className="text-body-3 text-gray-400">
                ⑦ 서비스는 회원이 서비스를 이용하여 기대하는 이익을 얻지 못하거나 상실한 것에 대하여
                책임을 지지 않습니다.
              </p>
              <p className="text-body-3 text-gray-400">
                ⑧ 회원이 모바일 기기의 변경, 모바일 기기의 번호 변경, 운영체제(OS) 버전의 변경, 해외
                로밍, 통신사 변경 등으로 인해 콘텐츠 전부나 일부의 기능을 이용할 수 없는 경우
          ...
          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">제14조 (회원에 대한 통지)</h2>
            <div className="space-y-3">
              <p className="text-body-3 text-gray-400">
                ① 서비스가 회원에게 통지를 하는 경우 회원의 전자우편주소, 문자메시지(LMS/SMS) 등으로
                할 수 있습니다.
              </p>
              <p className="text-body-3 text-gray-400">
          ...
          <section>
            <h2 className="text-title-2 mb-4 text-gray-100">제15조 (재판권 및 준거법)</h2>
            <p className="text-body-3 text-gray-400">
              이 약관은 대한민국 법률에 따라 규율되고 해석됩니다. 서비스와 회원 간에 발생한 분쟁으로
              소송이 제기되는 경우에는 법령에 정한 절차에 따른 법원을 관할 법원으로 합니다.
            </p>
          </section>

          <div className="space-y-4 text-center">
            <div className="text-body-3 py-6 text-gray-400">
              <ul className="text-body-3 list-inside space-y-2 text-gray-400">
                <li>약관 버전: v0.0.0</li>
                <li>공고일자: 2025.07.17</li>
