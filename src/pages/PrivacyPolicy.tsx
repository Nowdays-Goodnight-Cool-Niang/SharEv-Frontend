...
function PrivacyPolicy() {
  ...
  useScrollToTop();
  const tocLinkClass =
    'text-sm leading-6 block text-gray-600 hover:text-gray-800 hover:underline transition-colors duration-200';
  ...
  return (
    <div className="background flex flex-col bg-white dark:bg-gray-950">
      ...
      <div className="wrapper pb-14 pt-6">
        <div className="space-y-6 text-sm leading-7 tracking-tight text-gray-600 dark:text-gray-300">
          <div className="rounded-xl bg-gray-50 px-5 pb-4 pt-6 dark:bg-gray-900">
            <h3 className="mb-2 text-base font-semibold leading-7 tracking-tight text-gray-700 dark:text-gray-100">
              목차
            </h3>
          ...
          <div className="space-y-4 text-center">
            <p>
              SharE:v(이하 "서비스")는 정보주체의 자유와 권리 보호를 위해 ｢개인정보 보호법｣ 및 관계
              법령이 정한 바를 준수하여, 적법하게 개인정보를 처리하고 안전하게 관리하고 있습니다.
              이에 ｢개인정보 보호법｣ 제30조 에 따라 정보주체에게 개인정보의 처리와 보호에 관한 절차
              및 기준을 안내하고, 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여
              다음과 같이 개인정보 처리방침을 수립·공개합니다
            </p>
            <p className="font-medium text-gray-900">
              ※ SharE:v 서비스는
              <br /> 만 14세 이상 가입 및 이용 가능한 서비스로
              <br /> 만 14세 미만의 아동에 대해서는 회원 가입을 받지 않습니다.
            </p>
          </div>

          <section
            className="rounded-xl bg-gray-50 px-5 pb-4 pt-6 text-sm leading-7 tracking-tight text-gray-600 dark:bg-gray-900 dark:text-gray-300"
            id="article1"
          >
            ...
            <div className="mb-4">
              <h3 className="mb-2 font-semibold text-gray-700">개인정보 수집 방법</h3>
              <ul className="list-outside list-disc pl-4 text-gray-600">
            ...
            {/* 아이패드 이상 화면용 테이블 */}
            <div className="mb-4 hidden rounded-lg bg-white p-4 lg:block">
            ...
            <div className="mb-4 space-y-4 lg:hidden">
              <div className="rounded-lg bg-white p-4">
                <div className="space-y-3">
                  <div>
                    <h4 className="font-medium text-gray-800">법적 근거</h4>
                    <p className="text-gray-600">
                      「개인정보 보호법」 제15조제1항제4호 (계약 체결·이행)
                    </p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-800">구분</h4>
                    <p className="text-gray-600">회원 서비스 운영</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-800">처리 목적</h4>
                    <p className="text-gray-600">
                      회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격
                      유지·관리
                    </p>
                  ...
                  <div>
                    <h4 className="font-medium text-gray-800">처리 항목</h4>
                    <p className="text-gray-600">카카오 계정 정보(이메일, 닉네임)</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-800">처리 및 보유 기간</h4>
                    <p className="text-gray-600">회원 탈퇴 시까지</p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-lg bg-white p-4">
                <div className="space-y-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-800">구분</h4>
                    <p className="text-gray-600">네트워킹 서비스 제공</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-800">처리 목적</h4>
                    <p className="text-gray-600">이벤트 참가자 관리, 네트워킹 카드 생성 및 공유</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-800">처리 항목</h4>
                    <p className="text-gray-600">
              ...
              <div className="rounded-lg bg-white p-4">
                <div className="space-y-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-800">구분</h4>
                    <p className="text-gray-600">서비스 운영 및 보안</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-800">처리 목적</h4>
                    <p className="text-gray-600">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-800">처리 및 보유 기간</h4>
                    <p className="text-gray-600">회원 탈퇴 시 또는 수집일로부터 1년</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="ml-8">
                <ul className="list-outside list-disc space-y-1 pl-4 text-gray-600">
                  <li>
                    관계법령 위반에 따른 수사·조사 등이 진행중인 경우에는 해당 수사·조사 종료시까지
                  </li>
                  <li>
              ...
              <p className="mt-3 text-gray-600">③ 관계법령에 따른 보존 기간:</p>
              <ul className="ml-4 list-outside list-disc space-y-1 pl-4 text-gray-600">
          ...
          >
            ...
            <div className="space-y-3">
              <p className="mb-2 text-gray-600">
                ① 정보주체는 서비스에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수
                있습니다.
              </p>
              <ul className="list-outside list-disc pl-4 text-gray-600">
                <li>개인정보 열람요구</li>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-600">② 개인정보 파기의 절차 및 방법은 다음과 같습니다.</p>
              <ul className="ml-4 list-outside list-disc pl-4 text-gray-600">
                <li>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-600">
                ② 정보주체께서는 서비스의 서비스를 이용하시면서 발생한 모든 개인정보 보호 관련 문의,
                불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수
                있습니다. 서비스는 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
              </p>
            </div>
          </section>
