          ...
          {searchParams.get("tab") === TabType.info && (
            <div>
              ...
              <p className="text-body text-gray-500 mb-4">
                친구들과 함께 머리를 맞대고 밤새 새로운 아이디어를 구현하며,
                유쾌한 협업을 경험할 수 있는 오프라인 해커톤! GDG Campus Korea
                에서 캠퍼스 대항전 🐣삐약톤🐣을 주최합니다. 🎉 대학교의 이름을
                걸고 여러분의 반짝이는 아이디어와 열정을 마음껏 펼칠 수 있는 이
                자리에 함께 해주세요!함께 웃고 도전하며 성장할 수 있는 소중한
                시간을 만들어드릴게요. 여러분의 꿈과 열정을 응원하는 삐약톤에서
                만나요! 😊
              </p>
              <ButtonSecondary
                children={
