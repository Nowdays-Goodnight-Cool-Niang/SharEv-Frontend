  ...
  return (
    <label className={`flex cursor-pointer items-start gap-2 ${className}`}>
      <input
        ...
        checked={checked}
        onChange={onChange}
        className="mt-0.5 h-4 w-4 appearance-none rounded border border-gray-200 bg-white text-blue-500 checked:border-blue-500 checked:bg-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-offset-0"
      />
