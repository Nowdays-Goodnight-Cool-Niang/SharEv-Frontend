                    ...
                    <div className="mb-6 flex w-full flex-col items-center gap-4">
                      <div className="flex justify-center gap-3">
                        {myPin.split('').map((digit, index) => (
                          <div
                            key={index}
                            className="flex items-center justify-center rounded-xl border border-gray-200/5 bg-white/10 px-5 py-5"
                          >
            ...
            tabConfigs={[
              {
                ...
                content: (
                  <div className="my-6 flex flex-col items-center gap-4">
                    <div className="mx-auto w-full max-w-md overflow-hidden rounded-2xl border border-gray-100/20">
                      <QRScanner />
                    </div>
                ...
                content: (
                  <div className="pt-4">
                    <input
                      ...
                      placeholder="4자리 입력"
                      className="mb-3 w-full rounded-xl border border-gray-200/5 bg-white/10 px-5 py-3 text-center font-bold text-white transition-colors placeholder:text-gray-300/50 focus:border-gray-400/10 focus:outline-none"
                      maxLength={4}
                    />
                    <button
